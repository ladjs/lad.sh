...
Lad shall use all reasonable commercial efforts (no less than acceptable and reasonable industry standards) to ensure that the Lad service is available to paying customers 99.99% of the time in any calendar month.  If it is not, then you may be eligible to receive the [Credits](#credits) described below in accordance with [Eligibility](#eligibility).
...
[Business Source License 1.1](https://github.com/Lad/Lad.net/blob/master/LICENSE) © [Niftylettuce, LLC.](https://niftylettuce.com/)
